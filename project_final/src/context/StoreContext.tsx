...
export function StoreProvider({ children }: { children: React.ReactNode }) {
  ...
  const storeValue = useMemo(() => ({
    ...
    resendSpecialistInvitation: specialistsStore.resendSpecialistInvitation,
    ...
    specialistsStore.addSpecialist, specialistsStore.resendSpecialistInvitation,
    specialistsStore.updateSpecialist,
